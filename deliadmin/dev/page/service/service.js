...
define(['module', 'common/kernel/kernel', 'site/util/util'], function(module, kernel, util) {
    ...
    return {
        onload: function(force) {
            ...
            var tabpage = dom.find(".check-" + type);
            tabpage.show().siblings().hide();

            keyWord ? tabpage.find('.search-box .search').val(keyWord) : tabpage.find('.search-box .search').val('');

            //checkList(keyWord, loc.args.p);
        }
    };
});